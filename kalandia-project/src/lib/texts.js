...
<p>The project is fully realized through upcycling: all garments are created exclusively from used nylon tights, which function not only as a material but also as a structural and textural foundation for the entire collection.</p>
<p>The collection deliberately excludes traditional seams. All garment construction and surface formation were achieved using a textile welding machine (Stoffschweißmaschine), a heat-based device used for fusing textiles.
This technological approach redefines conventional garment-making methods and emphasizes the experimental nature of the project.</p>
The philosophical and visual concept of the collection is inspired by the atmosphere of the 1990s in the city of Zaporizhzhia — a period marked by transformation, instability, and the reconfiguration of identity.
At the core of the project lies the concept of the body and its interaction with secondary materials. The material undergoes a process of rebirth, transforming and adapting to the body, embodying the idea of material regeneration on both a physical and symbolic level.
<p>The collection explores the boundary between body and material, the organic and the industrial, vulnerability and resilience, proposing a new interpretation of sustainable fashion through the lenses of memory, technology, and corporeality.</p>`;

export const projectZP91Name = `Project RE:BIRTH ZP 91`;
